 ...
 */
class Building extends \App\Domain\Entities\Building implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'name', 'address', 'school', 'rooms', 'createdAt', 'updatedAt', 'deletedAt'];
        }
